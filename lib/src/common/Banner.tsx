...
export const Banner = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-1 h-[182px] w-[182px] overflow-hidden rounded-lg">
        {hero}
      </div>
      <div className="text-sm text-white">{header}</div>
      <div className="text-sm" style={{ color: CONFIG.colors.primary }}>
        {subHeader}
      </div>
      <div className="mx-auto">{content && content}</div>
    </div>
  )
}
