...
export const Browse = ({ config }: { config: ProjectConfig }) => {
  ...
  const getDurationText = (tokenData: TokenData) => {
    return tokenData.timeInvalidator?.parsed ? (
      <Tag className="flex w-full flex-row justify-between">
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="mx-5 flex gap-10 lg:flex lg:flex-row">
        <div className="w-[200px] rounded-lg text-left">
          <div>
            ...
            {!loaded ? (
              ...
              filteredAndSortedTokens.map((tokenData) => (
                ...
                >
                  ...
                  <div className="mt-1">
                    <div
                      className="flex flex-row text-base font-medium text-white opacity-95"
