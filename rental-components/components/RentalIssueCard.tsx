...
export const RentalIssueCard = ({
  ...
  const config = configFromToken(startingTokenDatas[0], walletId?.toString())
  console.log(walletId?.toString(), config)
        ...
        >
          ...
          <div className="flex gap-1">
            {selectedInvalidators.length > 0 && visibilities.length > 1 && (
              <Tooltip title="Set up your listing type or listing visibility">
                <div
