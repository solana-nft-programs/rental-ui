  ...
  miniroyale: {
    ...
    filter: {
      ...
      value: [
        ...
        'Hph3MGKor2b2vc8xdsUijnMXM7HmLR9U6DqKt4yuMMF5', // S4 loot
        'ENhJS2XRyp138k6GBaZ2UrwAwBGXChhtQJTCMQUBNEfs', // S4 premium
      ],
    },
    subFilters: [
      {
        ...
        filter: {
          type: 'creators',
          value: [
            'Hph3MGKor2b2vc8xdsUijnMXM7HmLR9U6DqKt4yuMMF5',
            'ENhJS2XRyp138k6GBaZ2UrwAwBGXChhtQJTCMQUBNEfs',
          ],
        },
      },
      {
...
Welcome to the Underground.`,
  ...
  default: {
    ...
    description:
      'This is an unverified collection. Feel free to use at your own risk, these NFTs may or may not be the real verified versions. Visit https://rent.host.so and request to add a verified collection.',
    hidden: true,
    type: 'Collection',
